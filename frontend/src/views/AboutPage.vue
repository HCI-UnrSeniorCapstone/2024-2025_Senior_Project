        ...
        <v-col cols="12" md="10" lg="8">
          <v-card class="pa-6 mb-10">
            ...
            <v-card class="pa-6 mb-8" elevation="2">
              ...
              <p class="mb-3">
                Conducting HCI research today often means stitching together
                multiple platforms for study creation, data collection,
                analytics, and session management.
              </p>
              <p class="mb-3">
                <strong>Fulcrum</strong> streamlines this experience by offering
                a single, flexible web-based interface that centralizes every
                step of the process.
              </p>
              ...
              <v-row>
                ...
                <v-col cols="12" md="4">
                  ...
                  <p>
                    Built-in support for capturing behavioral and biometric
                    data.
                  </p>
                </v-col>
                <v-col cols="12" md="4">
            ...
            <v-card class="pa-6 mb-8" elevation="2">
              ...
              <p class="mt-4 text-caption">
                ...
                Project for the University of Nevada, Reno - Department of
            ...
            <v-card class="cta-card pa-6" elevation="4">
              <v-row align="center">
                <v-col>
                  ...
                  <p v-else>
                    You’re all set! Start by creating your first study.
                  </p>
                </v-col>
                <v-col cols="auto">
                  <v-btn
