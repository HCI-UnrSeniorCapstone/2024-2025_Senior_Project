...
def get_all_measurements(study_name=None, run_time=10, task_name=None, exe_time=None, key_input_flag=False, move_flag=False, click_flag=False, scroll_flag=False, factor_name=0, parti_id=0, study_id=0, user_task_id=0, ran_measurment_id=0, factor_ID=0):
    ...
    if key_listener is None or not key_listener.running:
        ...
        create_csv(study_name, task_name, 'Keyboard Inputs', 'keyboard', keyboard_data, key_input_flag, factor_name, parti_id, study_id, user_task_id, ran_measurment_id, factor_ID)
        create_csv(study_name, task_name, 'Mouse Movement', 'mouse', mouse_move_data, move_flag, factor_name, parti_id, study_id, user_task_id, ran_measurment_id, factor_ID)
        create_csv(study_name, task_name, 'Mouse Clicks', 'mouse', mouse_click_data, click_flag, factor_name, parti_id, study_id, user_task_id, ran_measurment_id, factor_ID)
        create_csv(study_name, task_name, 'Mouse Scrolls', 'mouse', mouse_scroll_data, scroll_flag, factor_name, parti_id, study_id, user_task_id, ran_measurment_id, factor_ID)
        keyboard_data = []
        mouse_move_data = []
        mouse_click_data = []
        mouse_scroll_data = []
