...
-- If a task has no measurement type, it won't be in this table
...
CREATE TABLE study (
    ...
    study_design_type INT NOT NULL,
    expected_participants INT NOT NULL,
    FOREIGN KEY (study_design_type) REFERENCES study_design_type(study_design_type_id)
);
...
CREATE TABLE study_task_factor (
    ...
    task_id INT,
    factor_id INT,
    PRIMARY KEY (study_id, task_id, factor_id),
    FOREIGN KEY (study_id) REFERENCES study(study_id),
    FOREIGN KEY (task_id) REFERENCES task(task_id),
